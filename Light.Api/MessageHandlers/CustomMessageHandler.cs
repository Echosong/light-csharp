...
namespace Light.Api.Message {
    ...
    public partial class CustomMessageHandler : MessageHandler<DefaultMpMessageContext>  /*如果不需要自定义，可以直接使用：MessageHandler<DefaultMpMessageContext> */
    {
        ...
        private string appId = AppSettingsConstVars.WeixinAppId;
        private string appSecret = AppSettingsConstVars.WeixinAppSecret;
        ...
        public static Func<Stream, PostModel, int, IServiceProvider, CustomMessageHandler> GenerateMessageHandler = (stream, postModel, maxRecordCount, serviceProvider)
                         => new CustomMessageHandler(stream, postModel, maxRecordCount, null, false /* 是否只允许处理加密消息，以提高安全性 */, serviceProvider: serviceProvider);
        ...
        public CustomMessageHandler(Stream inputStream, PostModel postModel, int maxRecordCount = 0, Db db = null, bool onlyAllowEncryptMessage = false, IServiceProvider serviceProvider = null)
