    ...
    <div class="vue-box">
        <div class="c-panel">
            ...
            <el-table :data="dataList" size="mini" ref="multipleTable">
				...
				-->
                <el-table-column label="模板类型" prop="typeEnum" width="100px"></el-table-column>
                <el-table-column label="模板编码" prop="code" width="100px"></el-table-column>
                <el-table-column label="参数" prop="params" width="100px"></el-table-column>
                <el-table-column label="模板说明" prop="title"></el-table-column>
                <el-table-column label="魔板内容" prop="content"></el-table-column>
...
export default {
    ...
    data() {
        return {
            p: { pageSize: 20, page: 1, type: "", code: "" },
            dataCount: 0,
            dataList: [],
        };
    },
    methods: {
        // 数据刷新
        f5: function () {
            this.sa.put("/Template/listPage", this.p).then((res) => {
        ...
        del: function (data) {
            this.sa.confirm(
                ...
                function () {
                    this.sa
                        .delete("/Template/delete/" + data.id)
                        .then((res) => {
                            console.log(res);
        ...
        exportFile: function () {
            ...
            var titleObj = [
                ...
                { key: "code", name: "模板编码" },
                { key: "title", name: "模板说明" },
                { key: "content", name: "魔板内容" },
                { key: "id", name: "id" },
            ];
            this.sa
                .exportFile("/Template/listPage", this.p, titleObj)
                .then((res) => {
                    console.log(res);
                });
        },
