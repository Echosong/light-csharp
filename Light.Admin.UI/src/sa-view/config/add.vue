...
export default {
  ...
  data() {
    return {
      ...
      isShow: false,
      rules: {group:[],
code:[{ min: 0, max: 200, message: '长度在 200 个字符', trigger: 'blur' },],
value:[{ min: 0, max: 1000, message: '长度在 1000 个字符', trigger: 'blur' },],
name:[{ min: 0, max: 255, message: '长度在 255 个字符', trigger: 'blur' },],
type:[],
description:[{ min: 0, max: 1000, message: '长度在 1000 个字符', trigger: 'blur' },],},
      fileList:[],
    }
  },
  methods: {
